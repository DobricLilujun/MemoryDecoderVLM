...
#  DEC  = Qwen/Qwen3-1.7B  (28L, vocab=151936)
#
#  dstore 目录前缀 large_，与本脚本 EXP_ROOT 绑定（不与其他 VLM 共享）。
# =============================================================================
set -euo pipefail
...
EXP_NAME="v4_large_Qwen3-VL-4B_Qwen3-1.7B"
...
# ---------- Step 1: teacher dstores (prefix: large_) ----------
...
echo "==== V4_LARGE 全实验完成，结果在 $EVAL_DIR/ ===="
