...
#
#  注意：VLM 与 v4_large (4B) 不同 → teacher 分布不同，dstore 必须独立生成。
# =============================================================================
set -euo pipefail
...
EXP_NAME="v4_large_Qwen3-VL-8B_Qwen3-1.7B"
...
# ---------- Step 1: teacher dstores (VLM=Qwen3-VL-8B, DEC=Qwen3-1.7B) ----------
...
echo "==== V4_LARGE+1 全实验完成，结果在 $EVAL_DIR/ ===="
